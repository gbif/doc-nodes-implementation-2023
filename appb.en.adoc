[appendix]
== Participant progress 2023

At the end of each year, the GBIF Secretariat asks Participants to outline any work they have completed that aligns with the priority areas identified in the GBIF’s work programme. This appendix includes the Participants' progress reports from 2023.
